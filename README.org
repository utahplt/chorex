...
#+begin_src elixir
  ...
  Actor1.(var1) ~> Actor2.(var2_a)               # Use this if you run `mix format!`
...
*ACHTUNG!! =mix format= will rewrite =Actor1.var1= to =Actor1.var1()= which is something different! Wrap variables in parens like =Actor1.(var1)= if you want to use =mix format=!* This is an unfortunate drawback—suggestions on fixing this would be welcome.
